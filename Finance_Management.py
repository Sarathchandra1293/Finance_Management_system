...
class Login_Success_Window(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.configure(background="#daf7a6")
        self.lbl_Login_success = tk.Label(self, text="Login Success", font=("Source Serif Pro Semibold", 15),
                                          bg="yellow", fg="blue")
        self.lbl_Login_success.place(relx=0.150, rely=0.111, height=21, width=250)

        # create OK button
        self.btn_register = tk.Button(self, text="OK", font=("Source Serif Pro Semibold", 11), bg="yellow", fg="blue",
...
st = str(res)
st1 = str(res1)
int(hashlib.sha1(st.encode("utf-8")).hexdigest(), 16)
enc = abs(hash(st)) % (10 ** 8)
int(hashlib.sha1(st1.encode("utf-8")).hexdigest(), 16)
enc1 = abs(hash(st1)) % (10 ** 8)
...
class RegisterWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.lblRegister = tk.Label(self, text="Registration Page", font=("Source Serif Pro Semibold", 16),
                                    bg="dark green",
                                    fg="white")
        self.lblFName = tk.Label(self, text="Enter FirstName:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                                 fg="black")
        self.lblLName = tk.Label(self, text="Enter LastName:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                                 fg="black")
        self.lblLName = tk.Label(self, text="Enter LastName:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                                 fg="black")
        self.lblUId = tk.Label(self, text="Enter UserId:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                               fg="black")
        self.lblPwd = tk.Label(self, text="Enter Password:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                               fg="black")
        self.lblPin = tk.Label(self, text="Enter Pin:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                               fg="black")
        self.lblContactNo = tk.Label(self, text="Enter Contact No:", font=("Source Serif Pro Semibold", 10),
                                     bg="#daf7a6",
                                     fg="black")
        self.lblCity = tk.Label(self, text="Enter City:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                                fg="black")
        self.lblState = tk.Label(self, text="Enter State:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                                 fg="black")
        ...
        self.btn_register = tk.Button(self, text=" Register ", font=("Source Serif Pro Semibold", 11), bg="grey",
                                      fg="white", command=self.register)
        self.btn_cancel = tk.Button(self, text=" Back ", font=("Source Serif Pro Semibold", 11), bg="grey", fg="white",
    ...
    def register(self):
        ...
        db_cursor.execute("CREATE DATABASE IF NOT EXISTS abf")
        db_cursor.execute("use abf")
        db_cursor.execute(
            "Create table if not exists login(uid VARCHAR(30) NOT NULL  PRIMARY KEY,password VARCHAR(30),fname VARCHAR(30),lname VARCHAR(30),city VARCHAR(20),state VARCHAR(30),mobileno VARCHAR(10))")
        ...
        db_cursor.execute("use abf")
        query = "INSERT INTO login(uid,password,fname,lname,city,state,mobileno) VALUES ('%s','%s','%s','%s','%s','%s','%s')" % (
            enc, enc1, fname, lname, city, state, contact_no)
...
class LoginApp(tk.Tk):
    def __init__(self):
        ...
        self.configure(bg="#daf7a6")
        self.lblHeading = tk.Label(self, text="Amrita Banking Finance", font=("Source Serif Pro Semibold", 16),
                                   bg="dark green", fg="white")
        self.lbluname = tk.Label(self, text="Enter UserName:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                                 fg="black")
        self.lblpsswd = tk.Label(self, text="Enter Password:", font=("Source Serif Pro Semibold", 10), bg="#daf7a6",
                                 fg="black")
        self.txtuname = tk.Entry(self, width=60)
        self.txtpasswd = tk.Entry(self, width=60, show="*")
        self.btn_login = tk.Button(self, text="Login", font=("Source Serif Pro Semibold", 11), bg="grey", fg="white",
                                   command=self.login)
        self.btn_clear = tk.Button(self, text="Clear", font=("Source Serif Pro Semibold", 11), bg="grey", fg="white",
                                   command=self.clear_form)
        self.btn_register = tk.Button(self, text="Register", font=("Source Serif Pro Semibold", 11), bg="grey",
                                      fg="white", command=self.open_registration_window)
        self.btn_exit = tk.Button(self, text="Exit", font=("Source Serif Pro Semibold", 16), bg="dark green",
                                  fg="white",
                                  command=self.exit)
...
def Menu():
    print("*" * 157)
    print("|==========================================================|".center(150))
    print("|             +---AMRITA BANKING FINANCE---+               |".center(150))
    print("|                                                          |".center(150))
...
def Create():
    try:
        mycursor.execute(
            'create table bank(ACCNO varchar(10), NAME varchar(20), MOBILE varchar(10), EMAIL varchar(20), ADDRESS varchar(20), CITY varchar(10), COUNTRY varchar(20), BALANCE integer(15))')
